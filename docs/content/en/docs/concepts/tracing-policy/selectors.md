...
- Kernel support to manipulate raw registers is required.
- The new symbol must be already present in the binary.
- The new symbol must be compatible with the original symbol (ie: same signature); tetragon enforces no verification.
